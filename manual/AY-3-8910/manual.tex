...
% AY_3_8910 is an emulation of the AY_3_8910 sound chip from the Nintendo Entertainment System (NES) for VCV Rack. The AY_3_8910 chip contains two pulse wave generators, a quantized triangle wave generator, and a noise generator. The original chip featured a DMC loader for playing samples that has been omitted in this emulation.

% AY_3_8910 provides the key features of the AY_3_8910 chip, namely,
% \begin{itemize}
