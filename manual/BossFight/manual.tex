...
BossFight is an emulation and re-envisioning of the Yamaha YM2612 audio processing unit from the Sega Master System and Sega Genesis.

BossFight provides many of the key features of the Yamaha YM2612 chip, in addition to some hacks, omissions, and re-envisioned features, namely,
\begin{itemize}
  ...
  \item \textbf{Low-Frequency Oscillator:} A shared low-frequency oscillator controls amplitude modulation and frequency modulation of each operator.
