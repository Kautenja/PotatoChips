...
class YamahaYM2612 {
 ...
 public:
    ...
    ///
    inline void set_lfo(uint8_t value) { voice.set_lfo(value); }
    ...
    ///
    inline void set_am_sensitivity(uint8_t value) { voice.set_am_sensitivity(value); }
